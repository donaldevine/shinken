  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved test_case as @test_case" do
        ...
        post :create, {:test_case => { "title" => "invalid value" }}, valid_session
        assigns(:test_case).should be_a_new(TestCase)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested test_case" do
        ...
        TestCase.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => test_case.to_param, :test_case => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the test_case as @test_case" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TestCase.any_instance.stub(:save).and_return(false)
        put :update, {:id => test_case.to_param, :test_case => { "title" => "invalid value" }}, valid_session
        assigns(:test_case).should eq(test_case)
      end
