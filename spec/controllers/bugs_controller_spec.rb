  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved bug as @bug" do
        ...
        post :create, {:bug => { "title" => "invalid value" }}, valid_session
        assigns(:bug).should be_a_new(Bug)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested bug" do
        ...
        Bug.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => bug.to_param, :bug => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the bug as @bug" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Bug.any_instance.stub(:save).and_return(false)
        put :update, {:id => bug.to_param, :bug => { "title" => "invalid value" }}, valid_session
        assigns(:bug).should eq(bug)
      end
